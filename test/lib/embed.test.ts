...
describe("Embed ID validation", () => {
  describe("isValidButtonIdFormat", () => {
    it("should accept button IDs (n_xxx 8 chars)", () => {
    ...
    it("should accept button IDs (n_xxx 12 chars)", () => {
    ...
    it("should accept button IDs between 8-12 chars", () => {
    ...
    it("should reject invalid prefixes", () => {
      ...
      expect(isValidButtonIdFormat("btn_mOZiijcdVF60M1l0")).toBe(false);
    });

    it("should reject invalid characters", () => {
      expect(isValidButtonIdFormat("n_x7Kf-mQ2")).toBe(false);
      expect(isValidButtonIdFormat("n_x7Kf_mQ2")).toBe(false);
      expect(isValidButtonIdFormat("n_x7Kf mQ2")).toBe(false);
    });
